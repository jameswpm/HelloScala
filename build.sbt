...
libraryDependencies += "com.google.inject.extensions" % "guice-testlib" % "4.0" % "test"
...
libraryDependencies += "com.google.inject.extensions" % "guice-testlib" % "4.0" % "test" classifier "tests"
